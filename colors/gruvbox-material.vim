...
call gruvbox_material#highlight('Type', s:palette.purple, s:palette.none, 'bold')
if s:configuration.enable_bold
  call gruvbox_material#highlight('Function', s:palette.orange, s:palette.none, 'bold')
else
  call gruvbox_material#highlight('Function', s:palette.green, s:palette.none)
endif
call gruvbox_material#highlight('String', s:palette.aqua, s:palette.none, 'bold')
