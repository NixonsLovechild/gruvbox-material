...
call gruvbox_material#highlight('Type', s:palette.orange, s:palette.none)
if s:configuration.enable_bold
  call gruvbox_material#highlight('Function', s:palette.aqua, s:palette.none, 'bold')
else
  call gruvbox_material#highlight('Function', s:palette.green, s:palette.none)
endif
call gruvbox_material#highlight('String', s:palette.grey, s:palette.none, 'bold')
...
if s:configuration.enable_bold
  ...
  call gruvbox_material#highlight('GreyBold', s:palette.grey, s:palette.none, 'bold')
  ...
  call gruvbox_material#highlight('WhiteBold', s:palette.grey, s:palette.none)
...
highlight! link jsClassDefinition YellowBold
...
highlight! link jsModuleKeyword YellowBold
highlight! link jsObjectValue Blue
highlight! link jsTemplateExpression YellowBold
...
highlight! link typescriptTypeReference YellowBold
highlight! link typescriptBraces Fg
...
highlight! link typescriptInterfaceName YellowBold
...
highlight! link typescriptArrowFunc PurpleBold
highlight! link typescriptAbstract OrangeBold
...
highlight! link typescriptClassName YellowBold
highlight! link typescriptClassHeritage YellowBold
highlight! link typescriptInterfaceHeritage YellowBold
...
highlight! link typescriptTypeParameter YellowBold
